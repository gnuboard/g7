...
class MailTemplateCollection extends ResourceCollection
{
    ...
    {
        return [
            'data' => $this->mapWithRowNumber(function ($mailTemplate) {
                return (new MailTemplateResource($mailTemplate))->toArray(request());
            }),
