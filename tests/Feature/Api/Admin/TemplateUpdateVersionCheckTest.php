...
/**
 * 템플릿 업데이트 호환성 응답 페이로드 검증.
 */
class TemplateUpdateVersionCheckTest extends TestCase
{
    use RefreshDatabase;
    ...
    {
        $request = new \App\Http\Requests\Template\PerformTemplateUpdateRequest;
        $rules = $request->rules();
    ...
    public function test_check_updates_response_includes_compatibility_fields(): void
    {
        ...
        $response->assertStatus(200)
            ->assertJsonPath('data.details.sirsoft-admin_basic.is_compatible', true);
    }
}
