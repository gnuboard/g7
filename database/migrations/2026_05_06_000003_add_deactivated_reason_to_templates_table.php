...
return new class extends Migration
{
    ...
    public function up(): void
    {
        Schema::table('templates', function (Blueprint $table) {
            if (! Schema::hasColumn('templates', 'deactivated_reason')) {
            ...
            if (! Schema::hasColumn('templates', 'deactivated_at')) {
            ...
            if (! Schema::hasColumn('templates', 'incompatible_required_version')) {
        ...
        Schema::table('templates', function (Blueprint $table) {
            $table->index('deactivated_reason', 'templates_deactivated_reason_index');
        });
    }
    ...
    {
        Schema::table('templates', function (Blueprint $table) {
            $table->dropIndex('templates_deactivated_reason_index');
        });
