...
return new class extends Migration
{
    ...
    public function up(): void
    {
        Schema::table('modules', function (Blueprint $table) {
            if (! Schema::hasColumn('modules', 'deactivated_reason')) {
            ...
            if (! Schema::hasColumn('modules', 'deactivated_at')) {
            ...
            if (! Schema::hasColumn('modules', 'incompatible_required_version')) {
        ...
        Schema::table('modules', function (Blueprint $table) {
            $table->index('deactivated_reason', 'modules_deactivated_reason_index');
        });
    }
    ...
    {
        Schema::table('modules', function (Blueprint $table) {
            $table->dropIndex('modules_deactivated_reason_index');
        });
